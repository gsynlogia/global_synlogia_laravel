        ...
        <div class="w-64 sidebar-gradient shadow-2xl">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="{{ route('admin.admin.blog.index') }}" class="sidebar-item flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('admin.admin.blog.*') ? 'bg-white/20 border-l-4 border-white' : 'hover:bg-white/10' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
