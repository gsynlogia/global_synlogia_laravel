                    ...
                    @auth
                        <div class="flex items-center space-x-3">
                            ...
                            @if(auth()->user()->isSuperuser())
                                <a href="/admin" class="flex items-center px-3 py-2 text-sm font-medium text-[#de244b] hover:text-[#124f9e] transition-colors duration-200 {{ request()->is('admin*') ? 'text-[#124f9e]' : '' }}">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
