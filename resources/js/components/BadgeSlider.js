class BadgeSlider {
    constructor() {
        this.technologies = [
            { name: 'Swift', category: 'Mobile', icon: 'apple' },
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="relative">
                        <div class="flex overflow-hidden">
                            <div class="flex animate-scroll-left" id="slider-content" style="width:calc(200px * ${this.technologies.length});animation:scrollLeft 45s linear infinite">
        `;

        this.technologies.forEach((tech, index) => {
            html += `
                <a href="#" style="animation-delay:${index * 0.05}s"
